...
export class AppBskyPurchaseNS {
  ...
  getActiveSubscriptions<AV extends AuthVerifier>(
    cfg: ConfigOf<
      AV,
      AppBskyPurchaseGetActiveSubscriptions.Handler<ExtractAuth<AV>>,
      AppBskyPurchaseGetActiveSubscriptions.HandlerReqCtx<ExtractAuth<AV>>
    >,
  ) {
    const nsid = 'app.bsky.purchase.getActiveSubscriptions' // @ts-ignore
    return this._server.xrpc.method(nsid, cfg)
  }

  getPaidFeatures<AV extends AuthVerifier>(
    cfg: ConfigOf<
      AV,
      AppBskyPurchaseGetPaidFeatures.Handler<ExtractAuth<AV>>,
      AppBskyPurchaseGetPaidFeatures.HandlerReqCtx<ExtractAuth<AV>>
    >,
  ) {
    const nsid = 'app.bsky.purchase.getPaidFeatures' // @ts-ignore
    return this._server.xrpc.method(nsid, cfg)
  }
