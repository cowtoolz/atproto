...
export const schemaDict = {
  ...
  AppBskyPurchaseGetPaidFeatures: {
    lexicon: 1,
    id: 'app.bsky.purchase.getPaidFeatures',
    defs: {
      main: {
        type: 'query',
        description:
          'Enumerate paid feature flags related for the requesting account. Requires auth.',
        output: {
          encoding: 'application/json',
          schema: {
            type: 'object',
            ...
            properties: {
              features: {
                type: 'ref',
                ref: 'lex:app.bsky.purchase.getPaidFeatures#features',
              },
            },
          },
        },
...
export const ids = {
  ...
  AppBskyPurchaseGetPaidFeatures: 'app.bsky.purchase.getPaidFeatures',
