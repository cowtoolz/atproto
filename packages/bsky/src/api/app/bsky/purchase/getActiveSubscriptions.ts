...
const subscriptionProtoToXrpc = (
  ...
  ...subscription,
  periodEndsAt: subscription.periodEndsAt?.toJsonString(),
  periodStartsAt: subscription.periodStartsAt?.toJsonString(),
  purchasedAt: subscription.purchasedAt?.toJsonString(),
})
